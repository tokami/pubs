...
if(specNum == 16){
    ...
    ## Actinopterygii (ray-finned fishes) > Clupeiformes (Herrings) > Engraulidae v(Anchovies) > Engraulinae
...
ar <- c(
    "FMSYref2",
    "MSYHSref",
    ## MSY hockey stick rules + C percentile
    get.MP(fractileC = 0.45,npriorSD = npriorSD,
           breakpointB=0.5,nhist=nhist),
    ...
    ## MSY - A rules
    ## fractiles on C and Fmsy
    get.MP(fractileC = 0.45, npriorSD = npriorSD,
           fractileFFmsy = 0.45, fractileBBmsy = 0.45,
           nhist=nhist, breakpointB = 0),
    get.MP(fractileC = 0.4,npriorSD = npriorSD,
           fractileFFmsy = 0.4, fractileBBmsy = 0.4,
           nhist=nhist, breakpointB = 0),
    get.MP(fractileC = 0.35,npriorSD = npriorSD,
           fractileFFmsy = 0.35,fractileBBmsy = 0.35,
           nhist=nhist, breakpointB = 0),
    get.MP(fractileC = 0.3,npriorSD = npriorSD,
           fractileFFmsy = 0.3,fractileBBmsy = 0.3,
           nhist=nhist, breakpointB = 0),
    get.MP(fractileC = 0.25,npriorSD = npriorSD,
           fractileFFmsy = 0.25,fractileBBmsy = 0.25,
           nhist=nhist, breakpointB = 0),
    get.MP(fractileC = 0.15,npriorSD = npriorSD,
           fractileFFmsy = 0.15,fractileBBmsy = 0.15,
           nhist=nhist, breakpointB = 0),
    get.MP(fractileC = 0.05,npriorSD = npriorSD,
           fractileFFmsy = 0.05,fractileBBmsy = 0.05,
           nhist=nhist, breakpointB = 0),
...
## MSE
##--------------------------------------------------------------------------------
MSEAdd <- runMSE(OMup, MPs = ar, timelimit = 200, CheckMPs = FALSE,
...
## Save output
##--------------------------------------------------------------------------------
save(MSEAdd,file= paste0(savedir,"resMSE6Add_spec",specNum,"_scen",scenNum,"_nsim",nsim,
